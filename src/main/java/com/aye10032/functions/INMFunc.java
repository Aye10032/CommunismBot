...
public class INMFunc extends BaseFunc {
    ...
    public INMFunc(Zibenbot zibenbot) {
        ...
        commander = new CommanderBuilder<SimpleMsg>()
                ...
                .or("目力"::contains)
                .run((msg)->{
                    zibenbot.replyMsg(msg, zibenbot.getVoice(appDirectory + "/inm/目力.amr"));
                })
                .or(this::containsYarimasune)
                .run((msg)->{
                    zibenbot.replyMsg(msg, zibenbot.getVoice(appDirectory + "/inm/压力马斯内.amr"));
                })
                .or(this::containsSodayo)
                .run((msg)->{
                    zibenbot.replyMsg(msg, zibenbot.getVoice(appDirectory + "/inm/sodayo.amr"));
                })
                .build();
    }
